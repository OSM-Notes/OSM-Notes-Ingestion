<!--
SLD file to give colors and shapes to closed notes by country.
The color intensity shows how long ago the note was closed (lighter = older).
Different countries have different base colors and shapes for easy
identification, especially in border areas.

Color scheme:
- Each country gets a distinct base color (using hash of id_country)
...
- Shape is determined by country_shape_mod column (id_country % 6, pre-calculated in database)
...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" 
  ...
  <NamedLayer>
    <se:Name>notes closed by country</se:Name>
    <UserStyle>
      <se:Name>notes closed by country</se:Name>
      <se:FeatureTypeStyle>
