<!--
SLD file to give colors and shapes to open notes by country.
The color intensity shows the age of the note (darker = older).
...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" 
  ...
  <NamedLayer>
    <se:Name>notes open by country</se:Name>
    <UserStyle>
      <se:Name>notes open by country</se:Name>
      <se:FeatureTypeStyle>
