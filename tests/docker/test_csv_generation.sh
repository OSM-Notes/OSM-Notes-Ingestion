...
awkproc --maxdepth "${AWK_MAX_DEPTH:-4000}" ../../awk/notes-Planet-csv.awk test_output/test_planet.xml > test_output/planet_notes_test.csv
...
awkproc --maxdepth "${AWK_MAX_DEPTH:-4000}" ../../awk/note_comments-Planet-csv.awk test_output/test_planet.xml > test_output/planet_comments_test.csv
...
awkproc --maxdepth "${AWK_MAX_DEPTH:-4000}" ../../awk/note_comments_text-Planet-csv.awk test_output/test_planet.xml > test_output/planet_text_comments_test.csv
