...
4. **Service Provision:** Providing WMS (Web Map Service) layers for
   visualization
...
6. **Publication:** Data may be published via WMS layers
...
- **WMS Layers:** Simplified, aggregated data may be published via WMS
  services
